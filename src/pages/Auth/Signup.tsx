...
import { checkEmail, checkUsername, register } from "../../utils/user";
...
function Signup() {
  ...
  return (
    <div>
      ...
      >
        <Typography>
          <Typography.Title heading={5}>Sign Up</Typography.Title>
        </Typography>
      </div>
      ...
      >
        <Typography>
          <Typography.Text>
            <Link to="/i/flow/login">{"Already have an account? Sign in"}</Link>
          </Typography.Text>
        </Typography>
      </div>
    </div>
